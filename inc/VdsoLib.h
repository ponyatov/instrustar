...
#define VDSO_DLL_EXPORT extern "C" __declspec(dllexport)
#define VDSO_DLL_IMPORT extern "C" __declspec(dllimport)
#include <Windows.h>
#else
#define VDSO_DLL_EXPORT extern "C" __attribute__((visibility("default")))
#define VDSO_DLL_IMPORT extern "C" __attribute__((visibility("default")))
#define CALLBACK
#define WINAPI
#endif

#ifdef VDSO_LIBRARY
#define DLL_API VDSO_DLL_EXPORT
#else
#define DLL_API VDSO_DLL_IMPORT
#endif
...
///status/////////////////////////////////////////////////////////////////////////
/**********************************callback
functio**************************************** Description    This routines
sets the callback function of equipment status changed. Input:			ppara
the parameter of the callback function
　　				addcallback		a pointer to a function with the following
prototype: void AddCallBack( void * ppara)
                    rmvcallback		a pointer to a function with the following
prototype: Void RemoveCallBack( void * ppara) Output
*******************************************************************************************/
typedef void(CALLBACK* AddCallBack)(void* ppara);
typedef void(CALLBACK* RemoveCallBack)(void* ppara);
DLL_API void WINAPI SetDevNoticeCallBack(void* ppara, AddCallBack addcallback,
                                         RemoveCallBack rmvcallback);

/**************************************Event*************************************************
    Description  This routines set the event handle, these will be set, when
equipment status changed. Input:       addevent   the event handle rmvevent the
event handle Output
*******************************************************************************************/
...
///////////////////////////////////////////////////////////////////////////Oscilloscope///////////////////////////////////////////////////////////////////////////
/**************************************Capture
range************************************************* Description  This
routines set the range of input signal. 　　Input:      channel     the set
...
/**************************************Support Sample
Number******************************************** Description  This routines
get the number of samples that the equipment support. 　　Input:		- Output
Return value	the sample number
*************************************************************************************************/
DLL_API int WINAPI GetOscSupportSampleNum();

/**************************************Support
Sample******************************************** Description  This routines
get support samples of equipment.
　　Input:		sample			the array store the support samples of the
equipment maxnum			the length of the array Output		Return value
the sample number of array stored
*************************************************************************************************/
...
/**************************************Hardware
Trigger******************************************** Description  This routines
get the equipment support hardware trigger or not . 　　Input:      - 　　Output
Return value 1 support hardware trigger 0 not support hardware trigger
    关于触发：需要设备支持硬件触发
****************************************Hardware
Trigger*******************************************/
...
/**************************************Trigger
Mode*********************************************** Description  This routines
get the trigger mode. 　　Input:      - 　　Output     Return value
TRIGGER_MODE_AUTO TRIGGER_MODE_LIANXU
*************************************************************************************************/
DLL_API unsigned int WINAPI GetTriggerMode();
/**************************************Trigger
Mode*********************************************** Description  This routines
set the trigger mode. 　　Input:      mode  TRIGGER_MODE_AUTO 　　
TRIGGER_MODE_LIANXU Output
*************************************************************************************************/
...
/**************************************Trigger
Style*********************************************** Description  This routines
get the trigger style. 　　Input:      - 　　Output     Return value
TRIGGER_STYLE_NONE TRIGGER_STYLE_RISE_EDGE TRIGGER_STYLE_FALL_EDGE
                            TRIGGER_STYLE_EDGE
...
/**************************************Trigger
Style*********************************************** Description  This routines
set the trigger style. 　　Input:       style	TRIGGER_STYLE_NONE
...
/**************************************Pulse
Width*************************************************** Description  This
routines get the min time of pulse width. 　　Input:      - 　　Output Return
min time value of pulse width(ns)
*******************************************************************************************************/
DLL_API int WINAPI GetTriggerPulseWidthNsMin();
/**************************************Pulse
Width*************************************************** Description  This
routines get the max time of pulse width. 　　Input:      - 　　Output Return
max time value of pulse width(ns)
*******************************************************************************************************/
DLL_API int WINAPI GetTriggerPulseWidthNsMax();
/**************************************Pulse
Width*************************************************** Description  This
routines get the down time of pulse width. 　　Input:      - 　　Output Return
down time value of pulse width(ns)
*******************************************************************************************************/
DLL_API int WINAPI GetTriggerPulseWidthDownNs();
/**************************************Pulse
Width*************************************************** Description  This
routines set the down time of pulse width. 　　Input:      down time value of
pulse width(ns) 　　Output     -
*******************************************************************************************************/
DLL_API int WINAPI GetTriggerPulseWidthUpNs();
/**************************************Pulse
Width*************************************************** Description  This
routines set the up time of pulse width. 　　Input:      up time value of pulse
width(ns) 　　Output     _
*******************************************************************************************************/
DLL_API void WINAPI SetTriggerPulseWidthNs(int down_ns, int up_ns);

/**************************************Trigger
Source*********************************************** Description  This routines
get the trigger source. 　　Input:      - 　　Output     Return value  0
:channel 1 　　                         1 :channel 2
*************************************************************************************************/
DLL_API unsigned int WINAPI GetTriggerSource();
/**************************************Trigger
Source*********************************************** Description  This routines
set the trigger source. Input:      source  0 :channel 1 　　 1 :channel 2
　　Output      -
*************************************************************************************************/
DLL_API void WINAPI SetTriggerSource(unsigned int source);

/**************************************Trigger
level*********************************************** Description  This routines
get the trigger level. 　　Input:      - 　　Output     Return value  level (mV)
*************************************************************************************************/
DLL_API int WINAPI GetTriggerLevel();
/**************************************Trigger
level*********************************************** Description  This routines
set the trigger level. 　　Input:      level (mV) Output     -
*************************************************************************************************/
DLL_API void WINAPI SetTriggerLevel(int level);

/**************************************Trigger
Sense******************************************** Description  This routines get
the equipment support trigger sense or not . 　　Input:      - 　　Output Return
value 1 support 0 not support
****************************************Trigger
Sense*******************************************/
DLL_API int WINAPI IsSupportTriggerSense();
/**************************************Trigger
Sense*********************************************** Description  This routines
get the trigger Sense. 　　Input:      - 　　Output     Return value  Sense (0-1
div)
*************************************************************************************************/
DLL_API double WINAPI GetTriggerSenseDiv();
/**************************************Trigger
Sense*********************************************** Description  This routines
set the trigger Sense. 　　Input:      Sense (0-1div) Output     -
*************************************************************************************************/
DLL_API void WINAPI SetTriggerSenseDiv(double sense);

//
/**************************************Pre-trigger Percent
预触发比例******************************************** Description  This
routines get the equipment support Pre-trigger Percent or not . 　　Input: -
...
/**************************************Pre-trigger
Percent*********************************************** Description  This
routines get the Pre-trigger Percent. 　　Input:      - 　　Output     Return
value Percent (5-95)
*************************************************************************************************/
DLL_API int WINAPI GetPreTriggerPercent();
/**************************************Pre-trigger
Percent*********************************************** Description  This
routines set the Pre-trigger Percent. 　　Input:      Percent (5-95) Output -
*************************************************************************************************/
DLL_API void WINAPI SetPreTriggerPercent(int front);

/**************************************Trigger
Force******************************************** Description  This routines get
the equipment support trigger force or not . 　　Input:      - 　　Output Return
value 1 support 0 not support
****************************************Trigger
Force*******************************************/
DLL_API int WINAPI IsSupportTriggerForce();
/**************************************Trigger
Force*********************************************** Description  This routines
force capture once 　　Input: Output     -
*************************************************************************************************/
DLL_API void WINAPI TriggerForce();

/********************************************Support
AC/DC**************************************** Description  This routines get the
device support AC/DC switch or not. 　　Input:      - 　　Output     Return
value  0 :support AC/DC switch 1 :not support AC/DC switch
*************************************************************************************************/
DLL_API int WINAPI IsSupportAcDc();

/********************************************Set
AC/DC**************************************** Description  This routines set the
device AC coupling. 　　Input:      1 : set AC coupling 　　            0 : set
DC coupling Output     -
*************************************************************************************************/
...
/********************************************Get
AC/DC**************************************** Description  This routines get the
device AC coupling. 　　Input:      - 　　Output     Return value  1 : AC
coupling 　　                         0 : DC coupling
*************************************************************************************************/
DLL_API int WINAPI GetAcDc(unsigned int chn);

/**************************************Roll
Mode******************************************** Description  This routines get
the equipment support roll mode or not . 　　Input:      - 　　Output     Return
value 1 support roll mode 0 not support roll mode 关于Roll
Mode：需要设备支持Roll Mode
******************************************************************************************/
DLL_API int WINAPI IsSupportRollMode();

/**************************************Set Roll
Mode******************************************** Description  This routines
enable or disenable the equipment into roll mode. 　　Input:      - 　　Output
...
　　Input:      length  capture length(KB)
                force_length 1: force usint the length, no longer limits the
maximum collection 1 seconds Output     Return value  the real capture
length(KB)
*************************************************************************************************/
DLL_API int WINAPI Capture(int length, char force_length);
...
　　             datacallback  a pointer to a function with the following
prototype: void DataReadyCallBack ( void * ppara) Output       -
******************************************************************************************/
typedef void(CALLBACK* DataReadyCallBack)(void* ppara);
DLL_API void WINAPI SetDataReadyCallBack(void* ppara,
                                         DataReadyCallBack datacallback);

/******************************************************************************************
    Description  This routines set the event handle, these will be set, when
capture complete Input:       dataevent   the event handle Output      -
******************************************************************************************/
#ifdef _WINDOWS_PLATFORM
...
******************************************************************************************/
DLL_API unsigned int WINAPI ReadVoltageDatas(char channel, double* buffer,
                                             unsigned int length);
...
　　Output     Return value  if style==NULL return number of support wave styles
                             else store the styles to array, and return number
of wave style
******************************************************************************************/
...
/******************************************************************************************
    Description  This routines get dds output voltage is support software
control 　　Input:      - 　　Output     Return value support or not
******************************************************************************************/
...
/**************************************Support IO
Num******************************************** Description  This routines get
support io nums of equipment.
    Output		Return value	the sample number of io nums
*************************************************************************************************/
DLL_API int WINAPI GetSupportIoNumber();

/**********************************callback
function**************************************** Description    This routines
sets the callback function of read io status.
     Input:			ppara			the parameter of the callback function
　　				callback		a pointer to a function with the following
prototype: void IOReadStateCallBack(unsigned char channel, unsigned char state)
     Output
*******************************************************************************************/
typedef void(CALLBACK* IOReadStateCallBack)(void* ppara, unsigned char channel,
                                            char state);
DLL_API void WINAPI SetIOReadStateCallBack(void* ppara,
                                           IOReadStateCallBack callback);

/******************************************************************************************
    Description  This routines set the event handle, these will be set, when
read io status complete Input:       dataevent   the event handle Output      -
******************************************************************************************/
#ifdef _WINDOWS_PLATFORM
...
　　Input:       channel  channel number
    Output:      -1 not success
                 ...
                 1 state
******************************************************************************************/
DLL_API char WINAPI GetIOState(unsigned char channel);
